...
> Significant new features and development have shifted to the new [LTK Manager](https://github.com/LeageuTooIKit/ltk-manager).

A mod manager for **League of Legends** that allows you to install, manage and apply custom mods easily.

## 📥 Download

Go to the [Releases](https://github.com/LeageuTooIKit/cslol-manager/releases) page and download the latest version for your platform:
